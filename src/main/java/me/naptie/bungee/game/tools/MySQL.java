package me.naptie.bungee.game.tools;
...
public class MySQL {
	...
	public class Editor {
        ...
        /*public boolean set(int id, String key, String object) {
            int result;
            ...
            if (result == 0) {
                try {
                    result = this.statement.executeUpdate("insert into " + this.table + " values ('" + id + "', '" + object + "');");
                } catch (SQLException e) {
                    e.printStackTrace();
                    return false;
                }
